    ...
    <form id="form1" runat="server">
      ...
      <div class="row mt-3 row-cols-1">
        <!--row-container-->
          ...
          <!--col-1-->
          <label
            class="form-label font-monospace text-white ps-1 pe-1 bg-success rounded-3"
            >Gmail Hesabı</label
          >            
             
            <asp:TextBox ID="accountmail" runat="server" CssClass="form-control plach mt-1"  Font-Size="Small" TextMode="Email" placeholder="örnek@gmail.com"></asp:TextBox>
        </div>
        ...
        <div class="col mb-3">
          <!--col-4-->
          <label
            class="form-label mt-2 font-monospace text-white ps-1 pe-1 bg-success rounded-3"
            >Kime</label
          >
            
           <asp:TextBox ID="to" runat="server" CssClass="form-control plach mt-1" TabIndex="3" Font-Size="Small" TextMode="Email" placeholder="örnek2@gmail.com"></asp:TextBox>
        </div>
        ...
        <div class="col mb-3">
          ...
          <label
            ...
            >Başlık/Konu</label
          >
           <asp:TextBox ID="subject" runat="server" CssClass="form-control plach mt-1" TabIndex="4"  Font-Size="Small" placeholder="ders kayıtları"></asp:TextBox>
        </div>
      </div>
      <!--row-container-end-->
      ...
      <div class="mb-3">
        <label
          ...
          >Dosya Yükle</label
        >
          <asp:FileUpload ID="filemail" runat="server" CssClass="form-control mt-1" TabIndex="5" Font-Size="Small" ToolTip=".RAR .ZİP .EXE Uzantılı dosyalar desteklenmemektedir. Çoklu dosya yükleme mevcuttur." AllowMultiple="True"/>
      </div>
      ...
      <div class="mb-2">
        ...
        <label
          ...
          >Mesaj içerigi</label
        >
          <asp:TextBox ID="mailmessage" runat="server" TextMode="MultiLine" CssClass="form-control plach mt-1" Height="50" TabIndex="6" Font-Size="Medium" placeholder="Bu bir deneme mail mesajıdır."></asp:TextBox>
      </div>
      <!--textarea-end-->
